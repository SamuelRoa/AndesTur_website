            ...
            <div className="p-6 overflow-y-auto flex-1">
              {!ui.isSubmitted ? (
                ...
                >
                  ...
                  <p className="text-xs text-andes-gold font-medium mb-4">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center gap-2 px-6 py-2.5 bg-green-500 hover:bg-green-600 text-white text-xs font-semibold rounded-xl transition-all mb-3 shadow-md hover:shadow-lg"
                  >
